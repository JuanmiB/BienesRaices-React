...
const CardPropiedad = ({ result }) => {
    ...
    return (
        <>
            <div
                className="max-w-6xl min-w-[280px] border-2 rounded-lg border-grey cursor-pointer hover:border-2 hover:border-[var(--color-primary)] transition-all duration-200" // Agrega cursor-pointer para indicar que es clickeable
                key={result.titulo}
                    ...
                    <div className="md:max-w-md w-full">
                        <div className="bg-white shadow-xl rounded-lg overflow-hidden">
                            <div
                                ...
                                style={{ backgroundImage: `url(${result?.foto?.url})` }}
                            >
                            </div>
                            <div className="p-4">
                            ...
                            <div className="flex p-4 border-t border-gray-300 text-gray-700">
                                ...
                                <div className="flex-1 inline-flex items-center">
                                    ...
                                    <p><span className="text-gray-900 font-bold">{result.banos}</span> Bathrooms</p>
                                </div>
                            </div>
                            <div className="px-4 pt-3 pb-4 border-t border-gray-300 bg-gray-100">
                                ...
                                <div className="flex items-center pt-2">
                                    ...
                                    <div>
                                        <p className="font-bold text-gray-900">{result?.usuario?.nombre}</p>
