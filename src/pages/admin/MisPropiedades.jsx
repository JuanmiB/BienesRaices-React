                    ...
                    <li key={propiedad.id} className="py-5">
                        <div className="p-6 w-full flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-8 gap-4">
                            <div className="sm:w-1/4 md:w-1/6">
                                <img src={`/assets/uploads/${propiedad?.foto?.path}`} alt={`Imagen de la propiedad ${propiedad.titulo}`} />
                            </div>
                            ...
                            <div className="sm:w-1/4 md:w-2/6 lg:w-1/6 flex flex-col 2xl:flex-row gap-2">
                                ...
                                <form action={`eliminar/${propiedad.id}`} method="POST">
                                    ...
                                    <input type="submit" value="Eliminar" className="w-full font-bold rounded bg-red-200 text-center py-1 px-3 text-red-900 cursor-pointer" />
                                </form>
                            </div>
                        </div>
                    </li>
